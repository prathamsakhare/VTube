  ...
  return (
    ...
    >
      <VStack w={'full'}>
        ...
        ></video>
        <VStack alignItems={'start'} p={'8'} w={'full'} overflowX={'auto'}>
          <Heading>Sample Video 1</Heading>
          <Text>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus
            sequi explicabo labore repudiandae, consequuntur saepe obcaecati
            quibusdam autem aliquam culpa est placeat ullam recusandae unde
            assumenda ex, architecto repellendus maxime. Asperiores modi
            necessitatibus nisi fugiat odio voluptatem doloribus voluptas vitae
            debitis deleniti, sunt corporis, mollitia dicta in facilis ad
            consequuntur! Fuga repellat nihil qui aliquam accusantium delectus
            perferendis odit eligendi voluptate explicabo culpa ab quod
            praesentium quibusdam cumque aut laudantium.
          </Text>
        </VStack>
      </VStack>
      <VStack
